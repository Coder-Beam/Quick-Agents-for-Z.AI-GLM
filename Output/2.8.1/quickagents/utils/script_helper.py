...
class ScriptHelper:
    ...
    @staticmethod
    def run_command(cmd: str, cwd: str = None, timeout: int = 60,
                    capture: bool = True, check: bool = False) -> Dict:
        """
        执行命令
    ...
    def create_shortcut(target: str, shortcut_path: str, 
                        description: str = '', arguments: str = '') -> bool:
        """
        创建快捷方式（仅Windows）
    ...
    def set_registry_value(key: str, subkey: str, value_name: str, 
                           value: str, value_type: str = 'REG_SZ') -> bool:
        """
