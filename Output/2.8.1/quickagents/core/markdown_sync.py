...
class MarkdownSync:
    ...
    def __init__(self, db: UnifiedDB = None, docs_dir: str = 'Docs',
    ...
    def _generate_tasks_md(self, completed: List[Dict], in_progress: List[Dict],
                          pending: List[Dict], blocked: List[Dict]) -> str:
        """生成TASKS.md内容"""
