...
class KeywordMatcher:
    ...
    def _extract_requirements(self, doc_results: List[DocumentResult]) -> List[Dict]:
        items: List[Dict] = []
                ...
                items.append(
                    {
                        ...
                        "keywords": self._tokenize(
                            section.title + " " + (section.content or "")
                        ),
                    }
                )
    ...
    def _extract_code_items(self, code_result: SourceCodeResult) -> List[Dict]:
        items: List[Dict] = []
