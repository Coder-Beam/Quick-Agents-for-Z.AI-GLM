...
class BrowserInstaller:
    ...
    def install_lightpanda(self) -> Dict:
        ...
        try:
            print(f"[Installer] 正在下载 Lightpanda...")
    ...
    def ensure_installed(self, auto_install: bool = True) -> Dict:
        ...
        # 自动安装
        if auto_install:
            if not result['playwright']['installed'] or not result['chromium']['installed']:
                install_result = self.install_playwright()
                result['playwright']['installed'] = install_result['playwright_installed']
            ...
            if not result['lightpanda']['installed']:
                ...
                result['lightpanda']['installed'] = install_result['lightpanda_installed']
