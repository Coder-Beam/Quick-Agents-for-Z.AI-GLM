...
class CacheDB:
    ...
    def set_memory(self, key: str, value: Any, memory_type: str = 'factual',
    ...
    def check_loop(self, tool_name: str, tool_args: Dict, 
    ...
    def get_stats(self) -> Dict:
        ...
        with self._get_connection() as conn:
            ...
            # 操作统计
            cursor.execute('SELECT SUM(token_cost) as total_tokens FROM operation_history')
            ...
            return {
                ...
                'tokens': {
                    'total_saved': token_stats['total_tokens'] or 0
                }
            }
    ...
    def cleanup_old_records(self, days: int = 30) -> Dict:
        ...
        with self._get_connection() as conn:
            ...
            # 清理循环检测
            cursor.execute('DELETE FROM loop_detection WHERE last_seen < ?', (cutoff_str,))
            loops_deleted = cursor.rowcount
            
        return {
            'operations_deleted': ops_deleted,
            'loops_deleted': loops_deleted
        }
