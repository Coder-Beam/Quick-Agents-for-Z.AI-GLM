# AGENTS.md - AI编码代理通用开发规范

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![OpenCode Compatible](https://img.shields.io/badge/OpenCode-Compatible-blue.svg)](https://opencode.ai)
[![Version](https://img.shields.io/badge/Version-8.0-green.svg)](https://github.com)

> 一套完整的AI编码代理开发规范，支持智能询问、三维记忆系统、自动代理创建和Skills自我进化
...
- **单一触发词**：输入「启动AGENTS.MD」即可启动完整初始化流程
...
**A**: 复制 AGENTS.md 到新项目根目录，然后输入「启动AGENTS.MD」。
