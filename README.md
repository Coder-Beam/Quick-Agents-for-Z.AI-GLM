...
| 代理 | 调用方式 | 功能 |
|------|---------|------|
| yinglong-init | `启动QuickAgent` | 项目初始化 |
| boyi-consult | `@boyi-consult` | 需求分析 |
| chisongzi-advise | `@chisongzi-advise` | 技术推荐 |
| cangjie-doc | `@cangjie-doc` | 文档管理 |
| huodi-skill | `@huodi-skill` | Skill管理 |
| fenghou-orchestrate | `@fenghou-orchestrate` | 主调度器 |
